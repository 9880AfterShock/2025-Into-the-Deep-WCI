...
object MainLift { //Prefix for commands
    ...
    @JvmField
    var maxPos = 3.25 //all the way up
    @JvmField
    var maxLowPos = 3.25 //maximum position when lowered
    @JvmField
    var maxHangPos = 3.25 //maximum position when in hanging mode //temp values, CHANGE!

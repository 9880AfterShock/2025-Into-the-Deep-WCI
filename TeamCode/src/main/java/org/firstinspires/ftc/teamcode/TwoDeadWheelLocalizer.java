...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 656.3131860811405; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -887.5586661585796; // x position of the perpendicular encoder (in tick units)
    }

...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 678.8595504062888; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 901.1562443460292; // x position of the perpendicular encoder (in tick units)
    }

...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 732.2682180354577; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 924.1845690193886; // x position of the perpendicular encoder (in tick units)
    }

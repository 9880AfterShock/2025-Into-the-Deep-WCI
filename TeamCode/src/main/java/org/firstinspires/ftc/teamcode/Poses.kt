...
//
var pushPrepPoseRightBigFastHalfwayAsstronomical = Pose2d(-28.8,33.5,Math.toRadians(90.0))
var pushPrepPoseRightBigFastAsstronomical = Pose2d(-34.8,12.1,Math.toRadians(90.0)) //good // was -35
var pushPrepPoseRightSlideBigFastAsstronomical = Pose2d(-50.0, 12.1, Math.toRadians(0.0))
var pushPoseRightBigFastAsstronomical = Pose2d(-50.0, 46.0,Math.toRadians(90.0)) //good
var pushPrepPoseMidBigFastAsstronomical = Pose2d(-57.2,12.1,Math.toRadians(180.0)) // good
var pushPoseMidBigFastAsstronomical = Pose2d(-57.2, 46.0,Math.toRadians(180.0)) //good
//
...
var specEndPickupPoseBigAsstronomical = Pose2d(-44.2,56.5, Math.PI) // test for moving
var specStartPickupPoseSecondBigAsstronomical = Pose2d(-34.85, 58.155, Math.PI)//505
var specEndPickupPoseSecondBigAsstronomical = Pose2d(-44.7, 58.3, Math.PI)//-42.2, 60.1, math.pi

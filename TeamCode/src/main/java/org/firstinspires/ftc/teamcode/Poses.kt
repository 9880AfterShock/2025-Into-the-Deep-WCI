...
var samplePoseThree = Pose2d(45.1,44.5, Math.toRadians(-53.0))
//
...
//
var pushPrepPoseRightBigFastAsstronomical = Pose2d(-37.5,12.1,Math.toRadians(90.0)) //good // was -35.8
...
var clipPoseBlueTheFourthAsstronomical = Pose2d(3.0, 31.55, 0.0)// in need of Poses

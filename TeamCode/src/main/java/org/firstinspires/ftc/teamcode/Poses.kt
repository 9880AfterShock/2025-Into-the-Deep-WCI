...
var neutralPoseBlueFirst = Pose2d(35.5, 24.0,0.0)
var neutralPoseBlueSecond = Pose2d(43.0, 24.0,0.0) //need to change
...
var specStartPickupPoseLastBig = Pose2d(-36.2, 58.5, Math.PI)// in need of poses
var specEndPickupPoseLastBig = Pose2d(-44.2, 58.75, Math.PI)// in need of poses
...
var clipPoseBlueTheFourth = Pose2d(5.0, 31.0, 0.0)// in need of Poses

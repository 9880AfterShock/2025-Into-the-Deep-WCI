...
var neutralPoseBlueFirst = Pose2d(35.0, 26.0,0.0)
var neutralPoseBlueSecond = Pose2d(35.0, 26.0,0.0) //need to change
...
var specEndPickupPoseLastBig = Pose2d(-44.2, 59.5, Math.PI)//-42.2, 60.1, math.pi
